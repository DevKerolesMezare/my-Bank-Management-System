...
CreatedByUserID INT, Foreign key (CreatedByUserID) REFERENCES Users(UserID),
TransactionTypeID int, Foreign key (TransactionTypeID) REFERENCES TransactionTypes(TransactionTypeID)
)
...
FromAccountID int Foreign key (FromAccountID) REFERENCES Accounts(AccountID),
ToAccountID int Foreign key (ToAccountID) REFERENCES Accounts(AccountID),
CreatedByUserID INT Foreign key (CreatedByUserID) REFERENCES Users(UserID),
TransactionTypeID int Foreign key (TransactionTypeID) REFERENCES TransactionTypes(TransactionTypeID)
)
